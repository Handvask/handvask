...
=======
        ...
        for t in threads:
            t.start()
>>>>>>> local kubernetes can create 2 deployments, where one can contact the other to get the solution to a minizinc instance:minizinc/solver/main.py
    except:
